...
module.exports = {
  ...
  actions: (data) => {
    ...
    // If they want actions and a reducer, generate sessionActions.js, constants.js,
    // reducer.js and the corresponding tests for actions and the reducer
    if (data.wantActionsAndReducer) {
      // Actions
      actions.push({
        type: 'add',
        path: '../../app/containers/{{properCase name}}/sessionActions.js',
        templateFile: './container/sessionActions.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
